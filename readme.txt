...
Automatic installation is the easiest option as WordPress handles the file transfers itself and you don't need to leave your web browser. To perform an automatic install, log in to your WordPress dashboard, navigate to the Plugins menu and click Add New.
...
== Changelog ==
= 1.3 - 10-11-2019 =
* Improve coin precision / sub-total calculations (some more).
* Correct logging convention.
= 1.2 - 24-09-2019 =
